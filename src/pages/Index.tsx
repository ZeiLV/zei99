      ...
      {!showIntro && (
        <div className="min-h-screen">
          ...
          {selected ? (
            ...
            <main className="pt-20 sm:pt-24 px-4 sm:px-6 max-w-7xl mx-auto pb-16">
              ...
              {loading ? (
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-3 sm:gap-4 animate-fade-up">
                  {filtered.map((c) => (
